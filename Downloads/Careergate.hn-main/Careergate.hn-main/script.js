...
- Hiểu rõ các khái niệm quan trọng như CICD, infrastructure as code, Containerization, orchestration`, contact:"hr@abc.com", src:"fis.png"},
  {id:2, title:"Chuyên viên phân tích tài chính", category:"finance", company:"FinanceCorp", description:"Phân tích số liệu tài chính", requirements:"Excel, CFA là lợi thế", contact:"jobs@financecorp.com", src:"financecorp.png"},
  {id:3, title:"Nhân viên Marketing Online", category:"marketing", company:"MKT Agency", description:"Triển khai chiến dịch digital", requirements:"SEO, Ads", contact:"apply@mkt.com", src:"mkt-agency.png"},
  {id:4, title:"UI/UX Designer", category:"design", company:"DesignPro", description:"Thiết kế giao diện sản phẩm", requirements:"Figma, Adobe XD", contact:"hr@designpro.com", src:"designpro.png"},
...
TP. Hồ Chí Minh: Tòa nhà Himorin,Q4,HCM`, contact:"careers@aisolutions.com",src:"ai_solutio.png"},
  {id:6, title:"Chuyên viên kiểm toán", category:"finance", company:"Audit VN", description:"Kiểm toán báo cáo tài chính", requirements:"Kinh nghiệm 2 năm", contact:"apply@auditvn.com", src:"auditvn.png"},
  {id:7, title:"Content Creator", category:"marketing", company:"MediaHub", description:"Sáng tạo nội dung mạng xã hội", requirements:"Khả năng viết tốt", contact:"hr@mediahub.com", src:"mediahub.png"},
  {id:8, title:"Graphic Designer", category:"design", company:"ArtStudio", description:"Thiết kế ấn phẩm truyền thông", requirements:"Photoshop, Illustrator",benefits: ``,time:"time", location:"hanoi", contact:"jobs@artstudio.com", src:"artstudio.png"},
  ...
  container.innerHTML = jobs.slice(0,5).map(job => `
    <div class="job-card" onclick="window.location.href='job-detail.html?id=${job.id}'">
      <div class="job-card-content">
        <img src="${job.src || 'default-company.png'}" alt="${job.company} Logo" class="company-logo">
        <h3><a href="job-detail.html?id=${job.id}">${job.title}</a></h3>
        <div class="company-info">
          <img src="${job.src || 'default-company.png'}" alt="${job.company}" class="company-logo">
  ...
  anchorLinks.forEach(link => {
    link.addEventListener('click', function(e) {
      ...
      if (targetElement) {
        ...
        targetElement.style.boxShadow = '0 10px 30px rgba(52, 152, 219, 0.2)';
